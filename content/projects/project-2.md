...
## Project Details
Here's the thing about neurodegenerative disease research: we have access to tons of clinical MRI scans from hospitals – images taken during routine patient care – but they're often lower resolution and less standardized than the fancy research-grade scans. Most studies ignore this treasure trove of data and stick with high-resolution research MRIs. But what if we could unlock the potential of all that clinical data? That's exactly what I set out to do!
After successfully defending my M.D. thesis, I wasn't quite done with the neuroimaging world. I kept pushing forward with this work, focusing on improving the slice-to-volume reconstruction techniques I'd been using. The key innovation? Incorporating SynthSeg, a really clever generative AI-based framework that can segment MRIs regardless of their contrast or resolution. Unlike traditional segmentation tools that are picky about image quality, SynthSeg is remarkably robust.
